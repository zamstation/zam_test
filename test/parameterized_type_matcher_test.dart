...
void main() {
  ...
  group('ParameterizedTypeMatcher: ', () {
    ...
    test('When describe method is called with an empty description, the given type is appended to it.', () {
      expect(matcher.describe(StringDescription()).toString(), 'HeightNotValidException');
    });
    ...
    test('When matches method is called with a non-matching output, returns false.', () {
